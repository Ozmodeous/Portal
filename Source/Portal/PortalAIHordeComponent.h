...
public:
    ...
    // Configuration - moved bCanInitiateCommands to public
...
public:
    // Move AssignedFormationPosition to public to fix access issues
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Horde State")
...
private:
    ...
    // Make these mutable to fix const access issues
    mutable TArray<UPortalAIHordeComponent*> CachedNearbyMembers;
    mutable float NearbyMembersCacheTime = 0.0f;
